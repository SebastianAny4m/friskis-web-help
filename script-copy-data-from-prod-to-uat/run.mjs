...
const runBackup = async () => {
  const collectionsToDownload = ['activity', 'activityTest', 'goal', 'goalTest', 'coach', 'coachTest', 'feedback', 'feedbackTest', 'paypreparation', 'paypreparationTest', 'goalsettingconversation', 'goalsettingconversationTest']
